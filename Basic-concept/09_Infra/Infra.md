...
- AWS 관련 용어
  ...
  (7) S3(Simple Storage Service) : 이름 그대로 파일을 쉽게 저장할 수 있는 공간을 제공하는 서비스이다. 파일을 저장 할 수 있을 뿐만이 아니라 파일마다 고유 주소를 부여해주기 때문에 S3에 저장한 파일을 웹상에서 쉽게 읽어들일수 있다. 주로 사이트상의 이미지들을 저장하고 사이트에서 읽어들여 렌더링 해주는데 사용한다.
